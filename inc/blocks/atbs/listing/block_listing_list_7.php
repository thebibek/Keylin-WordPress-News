<?php
if (!class_exists('ATBS_Block_Posts_Listing_List_7')) {
    class ATBS_Block_Posts_Listing_List_7 {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_list_7-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--list-7 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list list-space-xl posts-list-style-15">';
        ...
        public function render_modules ($the_query, $moduleInfo = ""){
            ...
            $postOverlayAttr = array (
                ...
                'additionalTextClass'          => '',
                'typescale'                    => 'f-26 font-bold margin-bottom-25',
