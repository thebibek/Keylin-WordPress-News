<?php
if (!class_exists('ATBS_Block_Posts_Listing_List_5')) {
    class ATBS_Block_Posts_Listing_List_5 {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_list_5-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--list-5 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
