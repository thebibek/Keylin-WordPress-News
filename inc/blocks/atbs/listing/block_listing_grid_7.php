<?php
if (!class_exists('ATBS_Block_Posts_Listing_Grid_7')) {
    class ATBS_Block_Posts_Listing_Grid_7 {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_grid_7-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--grid-7'.$moduleBGPattern.$moduleCustomClass.' '.$blockMarginTopClass.'" '.esc_attr($moduleBGColor).'> ';
            ...
            $block_str .= '<div class="posts-list flexbox-wrap flexbox-wrap-2i posts-grid-style-17 clearfix">';
        ...
        public function render_modules ($the_query, $moduleInfo = ""){
            ...
            $postVerticalAttr = array (
                ...
                'typescale'                    => 'f-30 font-bold margin-bottom-18',
                'readmore'                     => 1,
                'readmoreIcon'                 => 1,
