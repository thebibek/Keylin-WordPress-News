<?php
if (!class_exists('ATBS_Block_Posts_Listing_Grid_Overlay_Aside_3')) {
    class ATBS_Block_Posts_Listing_Grid_Overlay_Aside_3 {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_grid_overlay_aside_3-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--grid-overlay-aside-3 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list posts-list-style-12 list-space-xxxl">';
        ...
        public function render_modules ($the_query, $moduleInfo = "") {
            ...
            $postHorizontalAttr_1 = array (
                'additionalClass'              => 'post--horizontal-middle post--horizontal-huge post--horizontal-huge-style-1  post-not-exist-thumb-disable',
                'additionalThumbClass'         => 'atbs-thumb-object-fit',
                'thumbSize'                    => 'atbs-s-1_1',
                'cat'                          => $catStyle,
                'catClass'                     => $cat_Class.' cat-line-after',
                'typescale'                    => 'f-34 font-bold margin-bottom-25',
//                'except_length'                => 15,
