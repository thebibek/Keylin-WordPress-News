<?php
if (!class_exists('ATBS_Block_Posts_Listing_Grid_1')) {
    class ATBS_Block_Posts_Listing_Grid_1 {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_grid_1-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--grid-1 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list posts-grid-style-2 flexbox-wrap flexbox-wrap-3i flex-space-30">';
