<?php
if (!class_exists('ATBS_Block_Posts_Listing_Grid_4')) {
    class ATBS_Block_Posts_Listing_Grid_4 {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_grid_4-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--grid-4 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list flexbox-wrap flexbox-wrap-3i flex-space-30 posts-grid-style-13">';
        ...
        public function render_modules ($the_query, $moduleInfo = ""){
            ...
            $postHorizontalAttr = array (
                'additionalClass'   =>  'post--horizontal-tiny post--horizontal-tiny-style-1 post-not-exist-thumb-disable',
                'thumbSize'         =>  'atbs-xxs-1_1',
                'additionalThumbClass'  => 'atbs-thumb-object-fit',
                'meta'              =>  array('date_without_icon'),
                'typescale'         =>  'f-16 font-semibold',
                'DarkMode'          => 1,
            );
            $render_modules = '';
            $currentPost = '';
