<?php
if (!class_exists('ATBS_Block_Posts_Listing_List_6')) {
    class ATBS_Block_Posts_Listing_List_6 {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_list_6-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--list-6 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list posts-list-style-16">';
        ...
        public function render_modules ($the_query, $moduleInfo = ""){
            ...
            $postHorizontalAttr = array (
                'additionalClass'              => 'post--horizontal-middle post--horizontal-large post--horizontal-large-has-bg post-thumb-height-370 entry-author-horizontal-middle',
                ...
                'typescale'                    => 'f-24 margin-bottom-25 font-bold',
