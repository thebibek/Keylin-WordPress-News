<?php
if (!class_exists('ATBS_Featured_Module_15')) {
    class ATBS_Featured_Module_15 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_featured_module_15-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-featured-module-15 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query){
            ...
            $postHorizontalAttr = array (
                'additionalClass'              => 'post--horizontal-middle post--horizontal-large-bg entry-author-horizontal-middle',
                'additionalThumbClass'         => 'atbs-thumb-object-fit height-100',
                'thumbSize'                    => 'atbs-m-4_3',
                'additionalTextClass'          => 'padding-40 height-100 bg-dark inverse-text flexbox-wrap flexbox-wrap-direction-column flexbox-center-x flexbox-top-y',
                'cat'                          => $catStyle,
                'catClass'                     => $cat_Class.' cat-line-after',
                'typescale'                    => 'f-30 font-bold line-limit-child line-limit-3',
//                'except_length'                => 20,
                'additionalExcerptClass'       => 'margin-bottom-25 line-limit line-limit-3',
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                if ($currentPost == 0):
                    ...
                    if ($currentPost == 1):
                        ...
                        $render_modules .= '<div class="posts-list flexbox-wrap flexbox-wrap-4i flex-space-30 posts-grid-style-9">';
                    endif;
