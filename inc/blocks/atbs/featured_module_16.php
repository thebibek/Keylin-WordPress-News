<?php
if (!class_exists('ATBS_Featured_Module_16')) {
    class ATBS_Featured_Module_16 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_featured_module_16-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-featured-module-16 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query){
            ...
            $postVerticalAttr_2 = array (
                'cat'                          => $catStyle,
                'catClass'                     => $cat_Class.' cat-color-gray cat-line-after',
                'additionalClass'              => 'post--vertical-small post--vertical-small-style-6',
                'additionalThumbClass'         => 'atbs-thumb-object-fit',
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                elseif ( ($currentPost > 0) && ($currentPost < 3) ):
                    if ( $currentPost == 1 ):
                        ...
                        $render_modules .= '<div class="posts-list list-space-xl posts-list-style-11">';
                    endif;
