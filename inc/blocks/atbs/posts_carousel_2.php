<?php
if (!class_exists('ATBS_Posts_Carousel_2')) {
    class ATBS_Posts_Carousel_2 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_posts_carousel_2-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-posts-carousel-2 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query) {
            ...
            $postOverlayAttr = array (
                ...
                'additionalClass'              => 'post--overlay-bottom post--overlay-floorfade post--overlay-height-580 post--overlay-huge post--overlay-huge-style-3 entry-author-horizontal-middle',
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                if ($currentPost == 0):
                    if ($maxPost <= 3):
                        ...
                        $render_modules .= '<div id="'.$carouselID.'" class="atbs-keylin-carousel owl-carousel js-carousel-3i4m nav-visible-on-hover nav-hidden-xs dots-circle dots-visible-xs" data-carousel-loop="true">';
                    endif;
                endif;
