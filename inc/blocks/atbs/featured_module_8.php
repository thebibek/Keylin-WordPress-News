<?php
if (!class_exists('ATBS_Featured_Module_8')) {
    class ATBS_Featured_Module_8 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_featured_module_8-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-featured-module-8 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query){
            ...
            $postOverlayAttr_1 = array (
                ...
                'additionalClass'              => 'post--overlay-bottom post--overlay-floorfade post--overlay-height-520 post--overlay-huge post--overlay-huge-style-1 entry-author-horizontal-middle',
            ...
            $postOverlayAttr_2 = array (
                'cat'                          => $catStyle,
                'catClass'                     => $cat_Class.' cat-line-after',
                'additionalClass'              => 'post--overlay-bottom post--overlay-floorfade post--overlay-height-520 post--overlay-medium',
                'additionalThumbClass'         => 'post__thumb--overlay atbs-thumb-object-fit',
                'thumbSize'                    => 'atbs-s-1_1',
                'additionalTextClass'          => 'inverse-text',
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                if ($currentPost == 0):
                    ...
                    if ($currentPost == 1):
                        ...
                        $render_modules .= '<div class="posts-list flexbox-wrap flexbox-wrap-2i flex-space-10 posts-grid-style-9">';
                    endif;
                    if ($postIconDetach != 1) {
                        $addClass = 'overlay-item--sm-p';
                        if ($postSource != 'all') {
