<?php
if (!class_exists('ATBS_Posts_Carousel_3')) {
    class ATBS_Posts_Carousel_3 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_posts_carousel_3-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-posts-carousel-3 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query) {
            ...
            $postOverlayAttr = array (
                ...
                'additionalClass'              => 'post--overlay-bottom post--overlay-floorfade post--overlay-height-620 post--overlay-huge post--overlay-huge-style-2 entry-author-horizontal-middle',
                'additionalThumbClass'         => 'post__thumb--overlay atbs-thumb-object-fit',
                'thumbSize'                    => 'atbs-l-16_9',
                'additionalTextClass'          => 'inverse-text',
                'typescale'                    => 'f-32 font-bold margin-bottom-15 line-limit-child line-limit-3',
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                if ($currentPost == 0):
                    if ($maxPost <= 2):
                        ...
                        $render_modules .= '<div id="'.$carouselID.'" class="atbs-keylin-carousel slider-content-visible owl-carousel-no-slide">';
                    else:
                        $render_modules .= '<div id="'.$carouselID.'" class="atbs-keylin-carousel owl-carousel js-carousel-3i4m-center nav-visible-on-hover nav-hidden-xs dots-circle dots-visible-xs" data-carousel-loop="true">';
                    endif;
                endif;
