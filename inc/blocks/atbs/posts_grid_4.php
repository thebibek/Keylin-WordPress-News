<?php
if (!class_exists('ATBS_Posts_Grid_4')) {
    class ATBS_Posts_Grid_4 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_posts_grid_4-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-posts-grid-4 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
