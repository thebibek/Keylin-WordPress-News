<?php
if (!class_exists('ATBS_Posts_Carousel_1')) {
    class ATBS_Posts_Carousel_1 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_posts_carousel_1-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-posts-carousel-1 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                if ($currentPost == 0):
                    if ($maxPost <= 2):
                        ...
                        $render_modules .= '<div id="'.$carouselID.'" class="atbs-keylin-carousel owl-carousel js-carousel-2i4m nav-visible-on-hover nav-hidden-xs dots-circle dots-visible-xs" data-carousel-loop="true">';
                    endif;
                endif;
