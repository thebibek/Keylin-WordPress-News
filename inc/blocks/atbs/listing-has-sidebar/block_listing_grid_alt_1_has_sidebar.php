<?php
if (!class_exists('ATBS_Block_Posts_Listing_Grid_Alt_1_Has_Sidebar')) {
    class ATBS_Block_Posts_Listing_Grid_Alt_1_Has_Sidebar {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_grid_alt_1_has_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--grid-alt-1 atbs-keylin-listing--grid-alt-1-has-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list posts-grid-style-3 posts-grid-has-sidebar flexbox-wrap flex-space-30">';
