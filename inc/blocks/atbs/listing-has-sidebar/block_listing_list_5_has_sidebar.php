<?php
if (!class_exists('ATBS_Block_Posts_Listing_List_5_Has_Sidebar')) {
    class ATBS_Block_Posts_Listing_List_5_Has_Sidebar {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_list_5_has_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--list-5 atbs-keylin-listing--list-5-has-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list list-space-xl posts-list-style-5 posts-list-has-sidebar">';
        ...
        public function render_modules ($the_query, $moduleInfo = ""){
            ...
            $postHorizontalAttr = array (
                'additionalClass'              => 'post--horizontal-middle post--horizontal-reverse post--horizontal-large post-thumb-height-340 post-not-exist-thumb-disable',
                'additionalThumbClass'         => 'atbs-thumb-object-fit',
                'thumbSize'                    => 'atbs-sm-1_1',
                'cat'                          => $catStyle,
                'catClass'                     => $cat_Class.' cat-line-after',
                'typescale'                    => 'f-24 font-bold',
                'except_length'                => 15,
