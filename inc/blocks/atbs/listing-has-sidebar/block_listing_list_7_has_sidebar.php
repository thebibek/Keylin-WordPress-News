<?php
if (!class_exists('ATBS_Block_Posts_Listing_List_7_Has_Sidebar')) {
    class ATBS_Block_Posts_Listing_List_7_Has_Sidebar {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_list_7_has_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--list-7 atbs-keylin-listing--list-7-has-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list list-space-xl posts-list-style-15 posts-list-has-sidebar">';
        ...
        public function render_modules ($the_query, $moduleInfo = ""){
            ...
            $postOverlayAttr = array (
                ...
                'additionalClass'              => 'post--overlay-height-520 post--overlap post--overlap-large post--overlap-position-bottom-left overlap-bg-light has-readmore',
                'additionalThumbClass'         => 'atbs-thumb-object-fit',
                'thumbSize'                    => 'atbs-l-16_9',
                'additionalTextClass'          => '',
                'typescale'                    => 'f-24 font-bold margin-bottom-25',
