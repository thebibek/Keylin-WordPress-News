<?php
if (!class_exists('ATBS_Block_Posts_Listing_List_6_Has_Sidebar')) {
    class ATBS_Block_Posts_Listing_List_6_Has_Sidebar {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_list_6_has_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--list-6 atbs-keylin-listing--list-6-has-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list posts-list-style-16 posts-list-has-sidebar">';
        ...
        public function render_modules ($the_query, $moduleInfo = ""){
            ...
            $postHorizontalAttr = array (
                'additionalClass'              => 'post--horizontal-middle post--horizontal-large post--horizontal-large-has-bg post-thumb-height-320 entry-author-horizontal-middle',
                'additionalThumbClass'         => 'atbs-thumb-object-fit height-100',
                'thumbSize'                    => 'atbs-s-1_1',
                'additionalTextClass'          => 'padding-40 height-100',
                'cat'                          => $catStyle,
                'catClass'                     => $cat_Class.' cat-line-after',
                'typescale'                    => 'f-22 font-bold  margin-bottom-25',
