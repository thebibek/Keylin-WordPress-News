<?php
if (!class_exists('ATBS_Block_Posts_Listing_List_2_Has_Sidebar')) {
    class ATBS_Block_Posts_Listing_List_2_Has_Sidebar {

        static $pageInfo = 0;

        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_block_posts_listing_list_2_has_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-listing--list-2 atbs-keylin-listing--list-2-has-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list list-space-xl posts-list-style-2 posts-list-has-sidebar">';
