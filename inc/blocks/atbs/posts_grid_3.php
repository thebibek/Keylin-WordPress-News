<?php
if (!class_exists('ATBS_Posts_Grid_3')) {
    class ATBS_Posts_Grid_3 {
        static $pageInfo = 0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('atbs_posts_grid_3-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-keylin-block atbs-keylin-block--fullwidth atbs-keylin-block-custom-margin atbs-keylin-posts-grid-3 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                if ($currentPost <= 1):
                    if ($currentPost == 0):
                        ...
                        $render_modules .= '<div class="posts-list flexbox-wrap flexbox-wrap-2i flex-space-30 posts-grid-style-10">';
                    endif;
