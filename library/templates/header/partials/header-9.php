...
<header class="site-header site-header--skin-2">
            ...
            <div class="container">
                <div class="top-bar__inner top-bar__inner--flex">
                    ...
                    <div class="top-bar__section flexbox-wrap flexbox-center-y">
                        <?php if ( isset($atbs_option ['bk-social-header']) && !empty(ATBS_Core::bk_get_social_media_links($atbs_option['bk-social-header'])) ){ ?>
                        <div class="top-bar__section-social">
                                <ul class="social-list social-list--sm list-horizontal social-list-header<?php echo esc_attr($topBarSocialClass); ?>">
    ...
    <!-- Navigation bar -->
    <nav class="navigation-bar navigation-bar--fullwidth hidden-xs hidden-sm js-sticky-header-holder <?php if ($inverseClass == "yes") echo " navigation-bar--inverse";?> <?php if (isset($atbs_option['bk-header-bg-style']) && ($atbs_option['bk-header-bg-style'] == 'image')) echo "navigation-bar--has-bg-img"; ?>">
        <div class="container">
