<?php
    ...
    if ((isset($atbs_option['bk-header-element-inverse'])) && (($atbs_option['bk-header-element-inverse']) == 1)){
    ...
    <div class="header-main hidden-xs hidden-sm">
    	...
    	<div class="container">
    		<div class="row row--flex row--vertical-center">
    			<div class="col-xs-3">
                    <?php if ( isset($atbs_option ['bk-social-header']) && ($atbs_option ['bk-social-header'] != '') ){ ?>
        				<div class="header-social">
        					<ul class="social-list social-list--lg list-horizontal<?php if ($inverseHeaderElements == "yes") echo " social-list--inverse";?>">
                ...
                <?php if ((isset($atbs_option['bk-header-subscribe-switch'])) && ($atbs_option['bk-header-subscribe-switch'] == 1)):?>
                    <?php if ((isset($atbs_option['bk-mailchimp-shortcode'])) && ($atbs_option['bk-mailchimp-shortcode'] != '')):?>
