...
?>
<footer class="site-footer footer-6 <?php if ($hasPattern == "yes") echo " has-bg-pattern";?> <?php if ($inverseClass == "yes") echo " site-footer--inverse inverse-text";?>">
    <div class="site-footer__section <?php if ($hasPattern == "yes") echo " has-bg-pattern";?> site-footer__section--seperated">
		<div class="container">
