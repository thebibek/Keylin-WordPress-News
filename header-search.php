...
if ((isset($atbs_option['bk-search-header-switch'])) && (($atbs_option['bk-search-header-switch']) == 1)){
    $bkHeaderType = ATBS_Core::bk_get_theme_option('bk-search-header-type');
}else {
...
<body <?php body_class();?>>
    ...
    ?>
    <div class="site-wrapper<?php echo esc_attr($darkModeEnabledClass.$darkModeDefaultClass.$darkModeClass);?> atbs-dedicated-search-header <?php echo ATBS_Header::atbs_dedicated_page_header_class($bkHeaderType);?>">
        <?php
