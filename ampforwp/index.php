...
<?php amp_header(); ?>
<div class="cntr b-w atbs-amp-index-page">
	<div class="hmp">
	...
	if (is_home() ){
	 if (get_query_var( 'paged' ) ) {
		...
		if($i==1 && $paged==1){ 
			?>
			<div class="fbp atbs-amp-first-article">
			    ...
			    <div class="fbp-cnt fbp-c">
				    ...
				    <?php amp_loop_title(); ?>
				    <div class="at-dt amp-post__meta">
					    <?php 
		...
		<?php } else { 
			...
			<div class="fsp atbs-amp-verticle-post">
			    ...
			    <div class="fsp-cnt">
				    ...
				    <div class="pt-dt amp-post__meta">
				    	<?php amp_loop_date(); ?>
				    </div>
					<?php }?>
			    </div>
