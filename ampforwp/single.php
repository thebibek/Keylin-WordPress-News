...
<?php amp_header(); ?>
<div class="atbs-amp-container atbs-amp-single">
		...
		<div class="cntr">
			<div class="sp-rl">
				<div class="sp-rt">
					...
					<?php } ?>
                    <div class="atbs-amp-single-pagination">
					...
					<div class="cmts atbs-amp-single-comment">
						<?php amp_comments();?>
					</div>
					<?php } ?>
...
<?php if(ampforwp_get_setting('single-design-type') == true && ampforwp_get_setting('ampforwp-swift-recent-posts')=='1' && !checkAMPforPageBuilderStatus(get_the_ID()) ) { ?>
	<div class="r-pf atbs-amp-related-posts">
		<div class="cntr">
		<?php 	
			$args = array(
				'posts_per_page' => 2,
		...
		if ($check_rp > 1) {?>
			<div class="atbs-amp-related-post-heading">
		...
		while( amp_loop('start', array( 'posts_per_page' => $number_of_posts ) ) ): ?>
			<div class="fsp atbs-amp-related-post-item atbs-amp-verticle-post">
				<?php if( ampforwp_has_post_thumbnail() ){
				    ...
				    <div class="fsp-img amp-article-featured-img">
